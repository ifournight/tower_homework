...
ActiveRecord::Schema.define(version: 20170407074847) do
  ...
  create_table "accesses", force: :cascade do |t|
    ...
    t.index ["access_type"], name: "index_accesses_on_access_type"
    t.index ["subject_id", "subject_type"], name: "index_accesses_on_subject_id_and_subject_type"
    t.index ["user_id", "subject_id", "subject_type", "access_type"], name: "has access index", unique: true
  ...
  create_table "todo_members", force: :cascade do |t|
    t.integer  "member_id",  null: false
    t.integer  "todo_id",    null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["member_id"], name: "index_todo_members_on_member_id"
    t.index ["todo_id"], name: "index_todo_members_on_todo_id"
  end
